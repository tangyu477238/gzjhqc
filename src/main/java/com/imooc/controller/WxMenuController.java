...
//        log.info(buyStrurl);
        ...
        setMenuButton(button1, "订购车票", buyStrurl);
        setMenuButton(button1, "月票充值", buyMonthTickUrl);
        setMenuButton(button1, "我要补票", bupiaoUrl);




        ////////////////////月票或补票/////////////////////////////////////////
        setMenuButton(button2, "订购车票", wk_buyStrurl);
        setMenuButton(button2, "月票充值", wk_buyMonthTickUrl);
        setMenuButton(button2, "我要补票", wk_bupiaoUrl);
